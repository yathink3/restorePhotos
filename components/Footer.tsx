  ...
  return (
    <footer className='text-center h-16 sm:h-20 w-full sm:pt-2 pt-4 border-t mt-5 flex sm:flex-row flex-col justify-between items-center px-3 space-y-3 sm:mb-0 mb-3'>
      ...
      <div className='flex space-x-4 pb-4 sm:pb-0'>
        <Link href='https://twitter.com/nutlope' className='group' aria-label='TaxPal on Twitter'>
        ...
        <Link href='https://github.com/Nutlope/restorePhotos' className='group' aria-label='TaxPal on GitHub'>
          <svg aria-hidden='true' className='h-6 w-6 fill-slate-500 group-hover:fill-slate-700'>
